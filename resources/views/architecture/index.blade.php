@php
    $meta = [
       ...
       "thumbnail" => config('app.cdn_endpoint') . "/img/og-architecture-thumbnail.jpg",
    ];
@endphp
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a class="d-flex flex-column align-items-center" href="{{ route('monument-zuc') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture_thumbnail.jpg" alt="Monument and Memorial Centre, Žuč">
                <p class="pt-3 pb-4 text-center text-dark">Monument and Memorial<br>Centre, Žuč</p>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('mosque-kakanj') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/mosque-kakanj_thumbnail.jpg" alt="Mosque, Kakanj">
                <p class="pt-3 pb-4 text-center text-dark">Mosque, Kakanj</p>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('mosque-jablanica') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/mosque-jablanica_thumbnail.jpg" alt="Mosque, Jablanica">
                <p class="pt-3 pb-4 text-center text-dark">Mosque, Jablanica</p>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('tunnel-of-hope') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/tunnel-of-hope-museum_thumbnail.jpg" alt="Tunnel of Hope – Museum">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('skender-pasha') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/skender-pasha-mosque_thumbnail.jpg" alt="Skender Pasha Mosque">
        ...
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a class="d-flex flex-column align-items-center" href="{{ route('multi-religion-complex') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/multi-religious-complex-little-jerusalem_thumbnail.jpg" alt='Multi-Religious Complex: "Little Jerusalem"'>
                <p class="pt-3 pb-4 text-center text-dark">Multi-Religious Complex: "Little<br>Jerusalem"</p>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('school-sip') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/primary-school-sip_thumbnail.jpg" alt="Primary School, Šip">
                <p class="pt-3 pb-4 text-center text-dark">Primary School, Šip</p>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('yugoslav-pavilion') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/yugoslav-pavilion-proposal_thumbnail.jpg" alt="Yugoslav Pavilion proposal">
    ...
    <div class="row justify-content-center">
        <div class="col col-lg-3 col-md-6 d-flex justify-content-center">
            <a href="{{ route('selected-arch') }}">
                <img src="{{ config('app.cdn_endpoint') }}/img/architecture/jb-tito-museum-sketch_thumbnail.jpg" alt="Selected Sketches and Models">
