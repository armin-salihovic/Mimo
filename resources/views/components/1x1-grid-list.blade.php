    ...
    <div class="py-24 px-4 sm:px-6">
        <div>
            ...
            <div class="pb-16 hidden md:block">
                <x-lazy-loading-wrapper :lqip="$item->lowQualityImagePlaceholder($thumbnailRole, 'index')">
                    <img
            ...
            <div class="flex justify-center md:justify-between md:items-center">
                ...
                <a href="{{ route($route, $item->slug) }}"
                   class="hidden md:block bg-neutral-900 hover:bg-neutral-700 text-white font-bold py-8 px-16">See
                    Sculpture</a>
            </div>
        </div>
    </div>
