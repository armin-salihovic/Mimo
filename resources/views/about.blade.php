@php
    $meta = [
       ...
       "thumbnail" => config('app.cdn_endpoint') . "/img/og-about-thumbnail.jpg",
    ];
@endphp
...
<div class="mb-5 d-flex justify-content-center">
    <img class="portrait" src="{{ config('app.cdn_endpoint') }}/img/mimo-portrait.jpg" alt="Emir Salihović Mimo Portrait">
</div>
...
<div class="mb-5 d-flex justify-content-center">
    <img class="portrait" src="{{ config('app.cdn_endpoint') }}/img/art/1990/189.jpg" alt="Emir Salihović Mimo Portrait Art">
</div>
